...
demoApp.controller('DemoCtrl', ['$scope', 'StepsService', function($scope, StepsService) {
        ...
        $scope.fullpage = function() {
            ...
            function exitHandler() {
                if (document.webkitIsFullScreen === false) {
                    ///fire your event
                    //alert("Please change to full screen to continue by clicking enable full screen")
                    //elem.webkitRequestFullscreen();
        ...
        function aftersubmit() {
            ...
            function send() {
                emailjs.send('mohitsri9@gmail.com', 'template_6c45wkf', json1) //Insert your email service ID and email template ID
